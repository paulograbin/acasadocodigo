...
public class ProductDAO {
	...
	public BigDecimal sumPricesPerType(BookType bookType) {
		TypedQuery<BigDecimal> query = manager.createQuery("select sum(price.value) from Product p join p.prices "
				+ "price where price.bookType = :bookType", BigDecimal.class);
